package com.files.filesmanagement.config;
...
@EnableAsync
@EnableScheduling
public class StreamingDataConfig implements AsyncConfigurer {
	
	  private final Logger log = LoggerFactory.getLogger(StreamingDataConfig.class);
